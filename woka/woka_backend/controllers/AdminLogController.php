...
class AdminLogController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        $orderby = Yii::$app->request->get('orderby', ' id desc ');
    ...
    {
        if(count($ids) > 0){
            $c = RbacAdminLog::deleteAll(['in', 'id', $ids]);
    ...
    {
        if (($model = RbacAdminLog::findOne($id)) !== null) {
            return $model;
        } else {
