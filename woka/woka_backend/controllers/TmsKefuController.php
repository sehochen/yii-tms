...
/**
 * TmsKefuController implements the CRUD actions for SusoOrder model.
 */
class TmsKefuController extends BaseController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel->searchKf(Yii::$app->request->queryParams);
