...
use common\models\common\rbac\RbacAdminUserRole;
use yii\helpers\Url;

$modelLabel = new RbacAdminUserRole();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            ...
            foreach ($models as $model) {
                ...
                echo '  <td>' . $model->id . '</td>';
                echo '  <td>' . $model->user->username . '</td>';
...
<div class="modal fade" id="edit_dialog" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <input type="hidden" class="form-control" id="id" name="RbacAdminUserRole[id]" />
          ...
          <div id="user_id_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="user_id" name="RbacAdminUserRole[user_id]" />
              </div>
          ...
          <input type="hidden" class="form-control" id="role_id" name="RbacAdminUserRole[role_id]" value="<?=$role_id?>"/>

          <div id="create_user_div" class="form-group">
              <label for="create_user" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("create_user")?></label>
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_user" name="RbacAdminUserRole[create_user]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="create_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_date" name="RbacAdminUserRole[create_date]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_user_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_user" name="RbacAdminUserRole[update_user]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_date" name="RbacAdminUserRole[update_date]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
