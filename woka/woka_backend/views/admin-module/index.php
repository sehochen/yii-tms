...
use common\models\common\rbac\RbacAdminModule;
use yii\helpers\Url;
$modelLabel = new RbacAdminModule();
?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "admin-module-form", "class"=>"form-horizontal", "action"=>Url::toRoute("admin-module/save")]); ?>                      
                 <input type="hidden" class="form-control" id="id" name="RbacAdminModule[id]" />
          ...
          <div id="code_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="code" name="RbacAdminModule[code]" placeholder="必填" />
              </div>
          ...
          <div id="display_label_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="display_label" name="RbacAdminModule[display_label]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
		<!-- 
...
-->
          <div id="des_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="des" name="RbacAdminModule[des]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
...
-->
          <div id="display_order_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="display_order" name="RbacAdminModule[display_order]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="create_user_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_user" name="RbacAdminModule[create_user]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="create_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_date" name="RbacAdminModule[create_date]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_user_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_user" name="RbacAdminModule[update_user]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_date" name="RbacAdminModule[update_date]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
