...
use common\models\common\rbac\RbacAdminRole;
use yii\helpers\Url;
$modelLabel = new RbacAdminRole();
?>
...
<div class="modal fade" id="edit_dialog" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <input type="hidden" class="form-control" id="id" name="RbacAdminRole[id]" />
          ...
          <div id="code_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="code" name="RbacAdminRole[code]" placeholder="必填" />
              </div>
          ...
          <div id="name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="name" name="RbacAdminRole[name]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="des_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="des" name="RbacAdminRole[des]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="create_user_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_user" name="RbacAdminRole[create_user]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="create_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_date" name="RbacAdminRole[create_date]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_user_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_user" name="RbacAdminRole[update_user]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_date" name="RbacAdminRole[update_date]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
