...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?=Url::base()?>/themes/backend/rbac/plugins/iCheck/square/blue.css">
...
<!-- iCheck -->
<script src="<?=Url::base()?>/themes/backend/rbac/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
