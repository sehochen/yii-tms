...
use common\models\common\rbac\RbacAdminMenu;
use yii\helpers\Url;
$modelLabel = new \common\models\common\rbac\RbacAdminMenu();
?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "admin-menu-form", "class"=>"form-horizontal", "action"=>Url::toRoute('admin-menu/save')]); ?>                      
                 <input type="hidden" class="form-control" id="id" name="RbacAdminMenu[id]" />
                 <input type="hidden" class="form-control" id="module_id" name="RbacAdminMenu[module_id]" value="<?=$module_id?>">                    
          ...
          <div id="code_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="code" name="RbacAdminMenu[code]" placeholder="必填" />
              </div>
          ...
          <div id="menu_name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="menu_name" name="RbacAdminMenu[menu_name]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
<!-- 
 ...
 -->
          <div id="des_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="des" name="RbacAdminMenu[des]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="display_order_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="display_order" name="RbacAdminMenu[display_order]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
<!-- 
 ...
 -->
          <div id="entry_url_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="entry_url" name="RbacAdminMenu[entry_url]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="controller_div" class="form-group">
              ...
              <div class="col-sm-10">
              	<select class="form-control" name="RbacAdminMenu[controller]" id="controller">
					<option>请选择</option>
    				<?php 	   
          ...
          <div id="action_div" class="form-group">
              ...
              <div class="col-sm-10">
              <select class="form-control" name="RbacAdminMenu[action]" id="action">
    			<option>请选择</option>
              </select>
<!-- <input type="text" class="form-control" id="action" name="AdminMenu[action]" placeholder="必填" />  -->
          ...
          <div id="has_lef_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="has_lef" name="RbacAdminMenu[has_lef]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="create_user_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_user" name="RbacAdminMenu[create_user]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="create_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_date" name="RbacAdminMenu[create_date]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_user_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_user" name="RbacAdminMenu[update_user]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_date" name="RbacAdminMenu[update_date]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
