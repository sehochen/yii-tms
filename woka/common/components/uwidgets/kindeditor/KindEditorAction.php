...
use common\components\uwidgets\kindeditor\Services_JSON;
...
class KindEditorAction extends Action
{
    ...
    public function init()
    {
        ...
        $this->php_path = Yii::getAlias('@webbase').'/upload/';
        $this->php_url = Yii::getAlias('@webbase').'/upload/';
        //根目录路径，可以指定绝对路径，比如 /var/www/attached/
        $this->root_path = Yii::getAlias('@webbase').'/upload/';
        //根目录URL，可以指定绝对路径
        $this->root_url = Yii::getAlias('@webbase').'/upload/';
        //图片扩展名
        //            $ext_arr = ['gif', 'jpg', 'jpeg', 'png', 'bmp'],
        //文件保存目录路径
        $this->save_path = Yii::getAlias('@webbase').'/upload/';
        //文件保存目录URL
