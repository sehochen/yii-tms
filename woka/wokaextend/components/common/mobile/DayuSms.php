...
class DayuSms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = yii::$app->params['dayuKeyId'];// "LTAIi7Hg9YwoJhKf"; // AccessKeyId

        $accessKeySecret = yii::$app->params['dayuKeySecret'];// "eeVjguWJtrZdh05f9GlVSWeoPwNp9c"; // AccessKeySecret
    ...
    public static function sendSms($tel,$code) {
        ...
        $request->setSignName(yii::$app->params['dayuSingnName']);

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode(yii::$app->params['dayuSmsId']);
