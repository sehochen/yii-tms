...
Class WxCustomService{
    ...
    public function inviteAccount($kfAccount, $invite_wx){

        $queryUrl = 'https://api.weixin.qq.com/customservice/kfaccount/inviteworker?access_token='.AccessToken::getAccessToken();
    ...
    public function getOnlineAccountList(){
        ...
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/customservice/getonlinekflist?access_token='.AccessToken::getAccessToken();
    ...
    public function sendMessage($tousername,$fromusername)
...
XML;
    ...
    public function sendMessageOne($tousername,$fromusername,$kf_account)
...
XML;
        ...
        return sprintf($template,$fromusername,$tousername, time(),$kf_account);
