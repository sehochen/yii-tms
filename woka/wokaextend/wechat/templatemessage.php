...
class TemplateMessage{
     ...
     */
    public static function setIndustry($wxid,$industryId1, $industryId2){
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/template/api_set_industry?access_token='.AccessToken::getAccessToken($wxid);
        $queryAction = 'POST';
        $template = array();
     ...
     */
    public static function getTemplateId($wxid,$templateIdShort){
        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/template/api_add_template?access_token='.AccessToken::getAccessToken($wxid);
        $queryAction = 'POST';
        $template = array();
     ...
     */
    public static function sendTemplateMessage($wxid,$data, $touser, $templateId, $url, $topcolor='#FF0000'){

        $queryUrl = 'https://api.weixin.qq.com/cgi-bin/message/template/send?access_token='.AccessToken::getAccessToken($wxid);
        $queryAction = 'POST';
        $template = array();
